...
HD_PWD='C:/Users/osher/Vivado_Projects/AXIS_SOBEL_BD3/AXIS_SOBEL_BD3.runs/base_axis_sobel_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_axis_sobel_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_axis_sobel_0_2.tcl
