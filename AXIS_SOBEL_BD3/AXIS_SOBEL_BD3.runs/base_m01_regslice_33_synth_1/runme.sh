...
HD_PWD='C:/Users/osher/Vivado_Projects/AXIS_SOBEL_BD3/AXIS_SOBEL_BD3.runs/base_m01_regslice_33_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_m01_regslice_33.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_m01_regslice_33.tcl
