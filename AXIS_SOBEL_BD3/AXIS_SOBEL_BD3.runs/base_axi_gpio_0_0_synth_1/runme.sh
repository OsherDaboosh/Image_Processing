...
HD_PWD='C:/Users/osher/Vivado_Projects/AXIS_SOBEL_BD3/AXIS_SOBEL_BD3.runs/base_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_axi_gpio_0_0.tcl
