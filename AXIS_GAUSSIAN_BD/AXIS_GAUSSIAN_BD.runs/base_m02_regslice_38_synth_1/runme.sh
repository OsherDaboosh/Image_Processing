...
HD_PWD='C:/Users/osher/Vivado_Projects/AXIS_GAUSSIAN_BD/AXIS_GAUSSIAN_BD.runs/base_m02_regslice_38_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_m02_regslice_38.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_m02_regslice_38.tcl
